...
while($row = mysqli_fetch_assoc($result)){
    ...
    $records[] = array("orderID"=>$row1["orderID"],"orderDate"=>$row1["orderDate"],"orderTotal"=>$row1["orderTotal"],"customerName"=>$row1["customerName"],"customerContact"=>$row1["customerPhone"],"customerEmail"=>$row1["customerEmail"],"customerAddress"=>$row1["customerAddress"]);
